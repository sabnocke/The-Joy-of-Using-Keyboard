...
class WebCrawler:
    def __init__(
            ...
            filter_url: Callable[[str, str], str | None],
            workers: int = 10,
            limit: int = 25,  # amount of pages to crawl through
    ):
        self.client = client
    ...
    async def process_one(self):
        ...
        # codiga-disable
            ...
            # retry handling here...
            pass
        finally:  # IMPORTANT, because else work might be left undone and thus leading to while True
            self.todo.task_done()
    ...
    async def crawl(self, url: str):
        ...
        found_links = await self.parse_link(
    ...
    async def parse_link(self, base: str, text: str) -> Set[str]:
...
"""
#TODO
Ideas for me to implement for better understanding:
- Respect robots.txt (what's that tho?)
